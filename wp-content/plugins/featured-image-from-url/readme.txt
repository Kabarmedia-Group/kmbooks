...
* Auto set screenshot as featured image
...
= 4.3.8 =
* Enhancement: all FIFU strings are translatable now (except by Troubleshooting section).

= 4.3.7 =
* Revamp: Auto set screenshot as featured image (simple, faster, does not save in the media library and available in the free version now).

= 4.3.6 =
* New: FIFU PRO (pay with Alipay, WeChat, bank transfers and more); fix: many possible conflicts with plugins that call session_start.
