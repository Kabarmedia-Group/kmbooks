        ...
        <nav class="navbar" id="nav">
            <div class="container px-4 px-md-0">
                ...
                <div class="navlink d-none d-lg-flex gap-4">
                    <a href="<?= get_site_url(); ?>/our-titles" class="text-davys small-caps">Home</a>
					<a href="<?= get_site_url(); ?>/about" class="text-davys  small-caps">About</a>
                    <a href="<?= get_site_url(); ?>/works" class="text-davys  small-caps">Work</a>
                    ...
                    <a href="#contact" class="text-davys  small-caps">Contact</a>
                </div>
                <div class="navlink d-none d-lg-flex gap-4">
                ...
                <div class="mobile-navlink d-lg-none position-absolute bg-lightgrey top-0 w-100 vh-100 pt-5 z-30">
                    ...
                    <div class="px-4 d-flex flex-column pt-3">
                        ...
                        <a onclick="myFunction(this)" href="<?= get_site_url(); ?>/about" class="mb-3 text-davys fs-3 fw-bold">About</a>
                        ...
                        <a href="https://www.tokopedia.com/kabarmedia" target="_blank"
                            class="btn second-button-shop mt-auto">Shop
                            Now
                        </a>
                    </div>
                </div>
